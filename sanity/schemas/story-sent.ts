...
const storyFromSchwab = {
  role: 'story', // will be _type
  identifier: 'string', // will be _id?
  uuid: 'uuid', // will be _id?
  language: 'string', // will be handled by localization
  moderationState: 'string', // list of options?
  urlAlias: 'string',
  hostname: 'string',
  title: 'string',
  subtitle: 'string',
