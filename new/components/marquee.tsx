 ...
 *
 * This componet uses Sanity's image color palatte metadata to ensure text has proper contrast regardless of the image's color scheme. https://www.sanity.io/docs/image-metadata#5bb0c7e96f42
 *
 * Main area of use is 'LandingPage' in the component lookup, but homepage and similar pages might make use of it.
 */
...
export default function Marquee({
  ...
  // Get inherent image dimensions to avoid CLS
  const { width } = getImageDimensions(image);
  // Image color palette for gradient
  const {
